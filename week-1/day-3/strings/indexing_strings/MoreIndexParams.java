public class MoreIndexParams {
    public static void main (String[] args) {
        ...
        int positionOfMaydm = statement.indexOf("Maydm");
        int lastPositionOfMaydm = statement.lastIndexOf("Maydm");
        int locationOfMade = statement.indexOf("Made");
        int placementOfExclamation = statement.lastIndexOf("!");

        // Your mission is to create println statements to satisfy project requirements:
        ...
        int maydmIndexes = statement.indexOf("Maydm");
        //System.out.println(maydmIndexes);
        maydmIndexes = statement.indexOf("Maydm", (maydmIndexes + 1));
        System.out.println(maydmIndexes);
        maydmIndexes = statement.indexOf("Maydm", (maydmIndexes + 1));
        System.out.println(maydmIndexes);
        maydmIndexes = statement.indexOf("Maydm", (maydmIndexes + 1));
